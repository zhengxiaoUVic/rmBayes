...
Installation time of the source package is about 20 minutes (Stan models need to be compiled). If you have R version 4.1.1 on Mac, Windows, or Ubuntu, you can directly install the binary package by calling
``` r
