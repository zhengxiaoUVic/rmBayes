...
<!-- badges: start -->
[![Build status](https://ci.appveyor.com/api/projects/status/3iqry01fu7p2adev/branch/main?svg=true)](https://ci.appveyor.com/project/zhengxiaoUVic/rmbayes/branch/main)
...
*Note: if the LaTeX equations (svg images) display “Unsupported Plug-in” on Safari, please try another web browser.*
