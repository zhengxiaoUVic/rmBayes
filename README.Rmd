...
(1) $t_i^{\star}\mid g\overset{\text{ind.}}{\sim}\mathcal{N}(0,g),$

(2) $(t_1^{\star},\dotsb,t_{a-1}^{\star})=(t_1,\dotsb,t_{a})\cdot\mathbf{Q},$

(3) $\text{and } \mathbf{I}_a-a^{-1}\mathbf{J}_a=\mathbf{Q}\cdot\mathbf{I}_{a-1}\cdot\mathbf{Q^{\top}},$
