...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_HDIc");
    reader.add_event(44, 42, "end", "model_HDIc");
    return reader;
}
#include <stan_meta_header.hpp>
class model_HDIc
  : public stan::model::model_base_crtp<model_HDIc> {
private:
        int N;
        int C;
        ...
        double hb;
public:
    model_HDIc(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_HDIc_namespace::model_HDIc";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_HDIc_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_HDIc_namespace::model_HDIc stan_model;
#ifndef USING_R
