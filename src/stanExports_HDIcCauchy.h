...
namespace model_HDIcCauchy_namespace {
using stan::model::model_base_crtp;
using namespace stan::math;
stan::math::profile_map profiles__;
static constexpr std::array<const char*, 25> locations_array__ =
  {" (found before start of program)",
  " (in 'HDIcCauchy', line 9, column 2 to column 15)",
  " (in 'HDIcCauchy', line 10, column 2 to column 22)",
  " (in 'HDIcCauchy', line 11, column 2 to column 20)",
  " (in 'HDIcCauchy', line 12, column 2 to column 14)",
  " (in 'HDIcCauchy', line 27, column 2 to column 19)",
  " (in 'HDIcCauchy', line 28, column 2 to column 18)",
  " (in 'HDIcCauchy', line 29, column 2 to column 23)",
  " (in 'HDIcCauchy', line 30, column 2 to column 28)",
  " (in 'HDIcCauchy', line 31, column 2 to column 28)",
  " (in 'HDIcCauchy', line 17, column 4 to column 36)",
  " (in 'HDIcCauchy', line 16, column 17 to line 18, column 3)",
  " (in 'HDIcCauchy', line 16, column 2 to line 18, column 3)",
  " (in 'HDIcCauchy', line 19, column 2 to column 21)",
  " (in 'HDIcCauchy', line 22, column 2 to column 24)",
  " (in 'HDIcCauchy', line 23, column 2 to column 21)",
  " (in 'HDIcCauchy', line 2, column 2 to column 17)",
  " (in 'HDIcCauchy', line 3, column 2 to column 17)",
  " (in 'HDIcCauchy', line 5, column 8 to column 9)",
  " (in 'HDIcCauchy', line 5, column 18 to column 19)",
  " (in 'HDIcCauchy', line 5, column 2 to column 23)",
  " (in 'HDIcCauchy', line 6, column 2 to column 13)",
  " (in 'HDIcCauchy', line 9, column 9 to column 10)",
  " (in 'HDIcCauchy', line 12, column 9 to column 10)",
  " (in 'HDIcCauchy', line 28, column 9 to column 10)"};
#include <stan_meta_header.hpp>
class model_HDIcCauchy final : public model_base_crtp<model_HDIcCauchy> {
private:
  int N;
  int C;
...
public:
  ~model_HDIcCauchy() {}
  model_HDIcCauchy(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_HDIcCauchy_namespace::model_HDIcCauchy";
    // suppress unused var warning
    (void) function__;
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_HDIcCauchy_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_HDIcCauchy_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"mu", "sigma", "tau", "b"};
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"mu\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(C) + "},\"block\":\"parameters\"},{\"name\":\"sigma\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"tau\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"b\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"parameters\"},{\"name\":\"se\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"hdi\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(C) + ",\"cols\":" + std::to_string(2) + "},\"block\":\"generated_quantities\"}]");
  }
...
using stan_model = model_HDIcCauchy_namespace::model_HDIcCauchy;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_HDIcCauchy_namespace::profiles__;
}
#endif
#endif
