...
namespace model_HDId_namespace {
using stan::model::model_base_crtp;
using namespace stan::math;
stan::math::profile_map profiles__;
static constexpr std::array<const char*, 38> locations_array__ =
  {" (found before start of program)",
  " (in 'HDId', line 11, column 2 to column 10)",
  " (in 'HDId', line 12, column 2 to column 22)",
  " (in 'HDId', line 13, column 2 to column 19)",
  " (in 'HDId', line 14, column 2 to column 19)",
  " (in 'HDId', line 15, column 2 to column 14)",
  " (in 'HDId', line 16, column 2 to column 14)",
  " (in 'HDId', line 19, column 2 to column 20)",
  " (in 'HDId', line 20, column 2 to column 20)",
  " (in 'HDId', line 39, column 2 to column 19)",
  " (in 'HDId', line 40, column 2 to column 18)",
  " (in 'HDId', line 41, column 2 to column 17)",
  " (in 'HDId', line 21, column 2 to column 25)",
  " (in 'HDId', line 22, column 2 to column 25)",
  " (in 'HDId', line 42, column 2 to column 23)",
  " (in 'HDId', line 43, column 2 to column 16)",
  " (in 'HDId', line 44, column 2 to column 30)",
  " (in 'HDId', line 45, column 2 to column 30)",
  " (in 'HDId', line 27, column 4 to column 40)",
  " (in 'HDId', line 26, column 17 to line 28, column 3)",
  " (in 'HDId', line 26, column 2 to line 28, column 3)",
  " (in 'HDId', line 29, column 2 to column 21)",
  " (in 'HDId', line 30, column 2 to column 21)",
  " (in 'HDId', line 33, column 2 to column 24)",
  " (in 'HDId', line 34, column 2 to column 36)",
  " (in 'HDId', line 35, column 2 to column 36)",
  " (in 'HDId', line 2, column 2 to column 17)",
  " (in 'HDId', line 3, column 2 to column 17)",
  " (in 'HDId', line 5, column 8 to column 9)",
  " (in 'HDId', line 5, column 18 to column 19)",
  " (in 'HDId', line 5, column 2 to column 23)",
  " (in 'HDId', line 6, column 2 to column 13)",
  " (in 'HDId', line 7, column 2 to column 19)",
  " (in 'HDId', line 8, column 2 to column 19)",
  " (in 'HDId', line 15, column 9 to column 10)",
  " (in 'HDId', line 16, column 9 to column 10)",
  " (in 'HDId', line 40, column 9 to column 10)",
  " (in 'HDId', line 41, column 9 to column 10)"};
#include <stan_meta_header.hpp>
class model_HDId final : public model_base_crtp<model_HDId> {
private:
  int N;
  int C;
...
public:
  ~model_HDId() {}
  model_HDId(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_HDId_namespace::model_HDId";
    // suppress unused var warning
    (void) function__;
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_HDId_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"mu", "sigma", "gt", "gb", "t", "b"};
    if (emit_transformed_parameters__) {
      std::vector<std::string> temp{"eta", "tau"};
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"mu\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"sigma\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"gt\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"gb\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"t\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(C) + "},\"block\":\"parameters\"},{\"name\":\"b\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"parameters\"},{\"name\":\"eta\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"tau\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"se\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"hdi\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(C) + ",\"cols\":" + std::to_string(2) + "},\"block\":\"generated_quantities\"},{\"name\":\"mu_t\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(C) + "},\"block\":\"generated_quantities\"}]");
  }
...
using stan_model = model_HDId_namespace::model_HDId;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_HDId_namespace::profiles__;
}
#endif
#endif
