...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_HDId");
    reader.add_event(53, 51, "end", "model_HDId");
    return reader;
}
#include <stan_meta_header.hpp>
class model_HDId
  : public stan::model::model_base_crtp<model_HDId> {
private:
        int N;
        int C;
        ...
        double hb;
public:
    model_HDId(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_HDId_namespace::model_HDId";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_HDId_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_HDId_namespace::model_HDId stan_model;
#ifndef USING_R
