...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_HDIdCauchy");
    reader.add_event(42, 40, "end", "model_HDIdCauchy");
    return reader;
}
#include <stan_meta_header.hpp>
class model_HDIdCauchy
  : public stan::model::model_base_crtp<model_HDIdCauchy> {
private:
        int N;
        int C;
        ...
        double tcrit;
public:
    model_HDIdCauchy(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_HDIdCauchy_namespace::model_HDIdCauchy";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_HDIdCauchy_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_HDIdCauchy_namespace::model_HDIdCauchy stan_model;
#ifndef USING_R
