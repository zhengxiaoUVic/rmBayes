...
#include "stanExports_HDIdCauchyFixed.h"

RCPP_MODULE(stan_fit4HDIdCauchyFixed_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_HDIdCauchyFixed")
