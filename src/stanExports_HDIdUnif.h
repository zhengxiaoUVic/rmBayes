...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_HDIdUnif");
    reader.add_event(40, 38, "end", "model_HDIdUnif");
    return reader;
}
#include <stan_meta_header.hpp>
class model_HDIdUnif
  : public stan::model::model_base_crtp<model_HDIdUnif> {
private:
        int N;
        int C;
        ...
        double tcrit;
public:
    model_HDIdUnif(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_HDIdUnif_namespace::model_HDIdUnif";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_HDIdUnif_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_HDIdUnif_namespace::model_HDIdUnif stan_model;
#ifndef USING_R
