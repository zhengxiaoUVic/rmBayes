...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_HDIdUnifFixed");
    reader.add_event(46, 44, "end", "model_HDIdUnifFixed");
    return reader;
}
#include <stan_meta_header.hpp>
class model_HDIdUnifFixed
  : public stan::model::model_base_crtp<model_HDIdUnifFixed> {
private:
        int N;
        int C;
        ...
        matrix_d Q;
public:
    model_HDIdUnifFixed(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_HDIdUnifFixed_namespace::model_HDIdUnifFixed";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_HDIdUnifFixed_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_HDIdUnifFixed_namespace::model_HDIdUnifFixed stan_model;
#ifndef USING_R
