...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_HDIstandard");
    reader.add_event(43, 41, "end", "model_HDIstandard");
    return reader;
}
#include <stan_meta_header.hpp>
class model_HDIstandard
  : public stan::model::model_base_crtp<model_HDIstandard> {
private:
        int N;
        int C;
        vector_d Y;
        ...
        double ht;
public:
    model_HDIstandard(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_HDIstandard_namespace::model_HDIstandard";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_HDIstandard_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_HDIstandard_namespace::model_HDIstandard stan_model;
#ifndef USING_R
