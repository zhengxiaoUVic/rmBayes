...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_HDIstandardHetero");
    reader.add_event(50, 48, "end", "model_HDIstandardHetero");
    return reader;
}
#include <stan_meta_header.hpp>
class model_HDIstandardHetero
  : public stan::model::model_base_crtp<model_HDIstandardHetero> {
private:
        int N;
        int C;
        vector_d Y;
        ...
        double ht;
public:
    model_HDIstandardHetero(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_HDIstandardHetero_namespace::model_HDIstandardHetero";
        ...
        try {
            ...
            validate_non_negative_index("sigma", "C", C);
            num_params_r__ += C;
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("sigma", "C", C);
        context__.validate_dims("parameter initialization", "sigma", "vector_d", context__.to_vec(C));
        Eigen::Matrix<double, Eigen::Dynamic, 1> sigma(C);
        size_t sigma_j_1_max__ = C;
        ...
        pos__ = 0U;
        validate_non_negative_index("t", "C", C);
        context__.validate_dims("parameter initialization", "t", "vector_d", context__.to_vec(C));
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                sigma = in__.vector_lb_constrain(0, C, lp__);
            else
                sigma = in__.vector_lb_constrain(0, C);
            current_statement_begin__ = 13;
            local_scalar_t__ gt;
            ...
            if (jacobian__)
                t = in__.vector_constrain(C, lp__);
            else
                t = in__.vector_constrain(C);
            // transformed parameters
            current_statement_begin__ = 18;
            validate_non_negative_index("eta", "C", C);
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> eta(C);
            stan::math::initialize(eta, DUMMY_VAR__);
            stan::math::fill(eta, DUMMY_VAR__);
            // transformed parameters block statements
            current_statement_begin__ = 19;
            stan::math::assign(eta, multiply(sigma, stan::math::sqrt(gt)));
            // validate transformed parameters
            const char* function__ = "validate transformed params";
            (void) function__;  // dummy to suppress unused var warning
            current_statement_begin__ = 18;
            size_t eta_j_1_max__ = C;
            ...
            for (int i = 1; i <= C; ++i) {
                ...
                lp_accum__.add(normal_log<propto__>(segment(Y, pos, get_base1(s, i, "s", 1)), (mu + get_base1(t, i, "t", 1)), get_base1(sigma, i, "sigma", 1)));
            ...
            lp_accum__.add((-(2) * sum(stan::math::log(sigma))));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_HDIstandardHetero_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        double mu = in__.scalar_constrain();
        vars__.push_back(mu);
        Eigen::Matrix<double, Eigen::Dynamic, 1> sigma = in__.vector_lb_constrain(0, C);
        size_t sigma_j_1_max__ = C;
        for (size_t j_1__ = 0; j_1__ < sigma_j_1_max__; ++j_1__) {
        ...
        vars__.push_back(gt);
        Eigen::Matrix<double, Eigen::Dynamic, 1> t = in__.vector_constrain(C);
        size_t t_j_1_max__ = C;
        for (size_t j_1__ = 0; j_1__ < t_j_1_max__; ++j_1__) {
        ...
        try {
            ...
            current_statement_begin__ = 18;
            validate_non_negative_index("eta", "C", C);
            Eigen::Matrix<double, Eigen::Dynamic, 1> eta(C);
            stan::math::initialize(eta, DUMMY_VAR__);
            stan::math::fill(eta, DUMMY_VAR__);
            ...
            validate_non_negative_index("se", "C", C);
            Eigen::Matrix<double, Eigen::Dynamic, 1> se(C);
            ...
            stan::math::assign(se, divide(sigma, stan::math::sqrt(get_base1(s, 1, "s", 1))));
            ...
            stan::model::assign(hdi, 
                        ...
                        subtract(mu_t, multiply(tcrit, se)), 
...
typedef model_HDIstandardHetero_namespace::model_HDIstandardHetero stan_model;
#ifndef USING_R
